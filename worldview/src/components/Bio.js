    ...
    return (
        <>
            ...
            <div>
                ...
                <p>His name literally means "Twin Sheep Shearer", which leads one to believe that Tom might merely be a reflection of a world trying to trim down humans' hubris. On a more tangible level, Tom likes to tell people he (like most other life forms) is sunlight captured and stored. As such, friends and associates often describe him as 'weird', 'crazy', and/or 'smart'. On the more comfortable bio-socio-geographic plane, Tom is a young man in Delaware, a problem-solver who likes to turn big dreams into reality.</p>
